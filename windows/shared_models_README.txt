================================================================
  NeuroMesh — shared_models/ SHARING ZONE
================================================================

This directory is the ONLY location visible to the public
NeuroMesh P2P network.
...
- Cloud-hosted models that use your personal API keys
  ...
  if you have configured them in NeuroMesh.
...
For more info: https://github.com/NeuroMesh-ai/neuromesh
================================================================